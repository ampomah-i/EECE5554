...
(cl:in-package sensor_stack-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <convert_to_quaternion-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'convert_to_quaternion-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_stack-srv:<convert_to_quaternion-request> is deprecated: use sensor_stack-srv:convert_to_quaternion-request instead.")))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <convert_to_quaternion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_stack-srv:yaw-val is deprecated.  Use sensor_stack-srv:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <convert_to_quaternion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_stack-srv:pitch-val is deprecated.  Use sensor_stack-srv:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <convert_to_quaternion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_stack-srv:roll-val is deprecated.  Use sensor_stack-srv:roll instead.")
  (roll m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<convert_to_quaternion-request>)))
  ...
  "sensor_stack/convert_to_quaternionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'convert_to_quaternion-request)))
  "Returns string type for a service object of type 'convert_to_quaternion-request"
  "sensor_stack/convert_to_quaternionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <convert_to_quaternion-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'convert_to_quaternion-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_stack-srv:<convert_to_quaternion-response> is deprecated: use sensor_stack-srv:convert_to_quaternion-response instead.")))

(cl:ensure-generic-function 'qx-val :lambda-list '(m))
(cl:defmethod qx-val ((m <convert_to_quaternion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_stack-srv:qx-val is deprecated.  Use sensor_stack-srv:qx instead.")
  (qx m))

(cl:ensure-generic-function 'qy-val :lambda-list '(m))
(cl:defmethod qy-val ((m <convert_to_quaternion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_stack-srv:qy-val is deprecated.  Use sensor_stack-srv:qy instead.")
  (qy m))

(cl:ensure-generic-function 'qz-val :lambda-list '(m))
(cl:defmethod qz-val ((m <convert_to_quaternion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_stack-srv:qz-val is deprecated.  Use sensor_stack-srv:qz instead.")
  (qz m))

(cl:ensure-generic-function 'qw-val :lambda-list '(m))
(cl:defmethod qw-val ((m <convert_to_quaternion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_stack-srv:qw-val is deprecated.  Use sensor_stack-srv:qw instead.")
  (qw m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<convert_to_quaternion-response>)))
  ...
  "sensor_stack/convert_to_quaternionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'convert_to_quaternion-response)))
  "Returns string type for a service object of type 'convert_to_quaternion-response"
  "sensor_stack/convert_to_quaternionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'convert_to_quaternion)))
  ...
  "sensor_stack/convert_to_quaternion")