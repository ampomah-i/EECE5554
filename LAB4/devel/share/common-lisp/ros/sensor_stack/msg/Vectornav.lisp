...
(cl:defmethod cl:initialize-instance :after ((m <Vectornav>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vectornav)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_stack-msg:<Vectornav> is deprecated: use sensor_stack-msg:Vectornav instead.")))
...
(cl:defmethod imu-val ((m <Vectornav>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_stack-msg:imu-val is deprecated.  Use sensor_stack-msg:imu instead.")
  (imu m))

(cl:ensure-generic-function 'mag_field-val :lambda-list '(m))
(cl:defmethod mag_field-val ((m <Vectornav>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_stack-msg:mag_field-val is deprecated.  Use sensor_stack-msg:mag_field instead.")
  (mag_field m))

(cl:ensure-generic-function 'VNYMR-val :lambda-list '(m))
(cl:defmethod VNYMR-val ((m <Vectornav>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_stack-msg:VNYMR-val is deprecated.  Use sensor_stack-msg:VNYMR instead.")
  (VNYMR m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Vectornav>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'VNYMR))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'VNYMR))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Vectornav>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'mag_field) istream)
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'VNYMR) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'VNYMR) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Vectornav>))
  (cl:+ 0
     ...
     4 (cl:length (cl:slot-value msg 'VNYMR))
))
