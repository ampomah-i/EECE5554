...
(cl:defmethod cl:initialize-instance :after ((m <gps_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gps_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_stack-msg:<gps_msg> is deprecated: use sensor_stack-msg:gps_msg instead.")))
