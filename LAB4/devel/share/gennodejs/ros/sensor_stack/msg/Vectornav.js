...
class Vectornav {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('VNYMR')) {
        this.VNYMR = initObj.VNYMR
      }
      else {
        this.VNYMR = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [VNYMR]
    bufferOffset = _serializer.string(obj.VNYMR, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [VNYMR]
    data.VNYMR = _deserializer.string(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.VNYMR);
    return length + 4;
  }

  static datatype() {
    // Returns string type for a message object
    return 'sensor_stack/Vectornav';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '79e0ef590b4e3298e715692ed121bb90';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.VNYMR !== undefined) {
      resolved.VNYMR = msg.VNYMR;
    }
    else {
      resolved.VNYMR = ''
    }
