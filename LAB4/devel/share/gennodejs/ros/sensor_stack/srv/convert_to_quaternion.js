...
class convert_to_quaternionRequest {
  ...
  static datatype() {
    ...
    return 'sensor_stack/convert_to_quaternionRequest';
  }
...
class convert_to_quaternionResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'sensor_stack/convert_to_quaternionResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'sensor_stack/convert_to_quaternion'; }
};
