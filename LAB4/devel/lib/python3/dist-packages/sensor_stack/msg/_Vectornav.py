...
"""autogenerated by genpy from sensor_stack/Vectornav.msg. Do not edit."""
import codecs
import sys
...
class Vectornav(genpy.Message):
  _md5sum = "79e0ef590b4e3298e715692ed121bb90"
  _type = "sensor_stack/Vectornav"
...
MSG: sensor_msgs/MagneticField
 ...
 float64[9] magnetic_field_covariance # Row major about x, y, z axes
  ...
  __slots__ = ['header','imu','mag_field','VNYMR']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.VNYMR = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.VNYMR = str[start:end]
      return self
