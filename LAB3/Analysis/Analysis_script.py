...
A = [((7.1518831468475875e-06 + 1.0238833502856521e-05 + 9.387822204108751e-05)/3),
     ((3.933532723621526e-07 + 3.52893912237541e-07 + 4.691809177914013e-05)/3),
     (9.008385766734497e-05 + 0.00011251055500392538 + 9.06000926482027e-05)/3] 
B = [((3.191173872294055e-06 + 4.502109659453816e-06 + 6.638548258501407e-05)/3),
     (1.015722695114417e-07 + 2.461989333076988e-05 + 1.1215079697551602e-07)/3,
     (8.825940766158217e-05 + 0.00011353429282313906 + 9.060110740548173e-05)/3]
C = [((2.429954284336846e-06 + 4.209118029640888e-05 + 2.92276708241817e-06)/3),
     ((2.1375330041835408e-08 + 7.921618493094718e-06 + 9.713790802485102e-08)/3),
     (0.00012804471957808834 + 0.0001914811675978003 + 9.813867306542871e-05)/3] 
D = [((5.113344436910492e-06 + 6.7188417680879684e-06 + 4.751719539360507e-06)/3),
     (3.199813143719699e-08 + 1.9098438613080355e-07 + 1.1764682272857527e-07)/3,
     (9.511538905150916e-05 + 0.00011811834203198564 + 0.00012741442502130318)/3]
print(A)
print(B)
print(C)
print(D)
print('----------------------------------------')
sort1 = [A[0],B[0],C[0],D[0]]
sort1.sort()
sort2 = [A[1],B[1],C[1],D[1]]
sort2.sort()
sort3 = [A[2],B[2],C[2],D[2]]
sort3.sort()
